<template>
  <div>
    <div v-if="!preview">
      <div class="widgetsPanelContent" style="display:flex">
        <vx-tooltip text="Titre">
          <vs-button
            size="small"
            class="btnTooltipGroup"
            title="titre"
            color="primary"
            type="filled"
            icon-pack="feather"
...
export default {
  ...
  created() {
    ...
    var getCustomers = db
      ...
      .doc(localStorage.getItem("idCustomer"))
      .collection("sites")
      .doc(localStorage.getItem("idSite"))
      .get()
      .then(function(doc) {
